...
;;{{{ Add-on from Jérôme LELONG for ispell

(defun jl-ispell-lang( lang )
  (interactive "sLanguage  : fr gb ")
  (if (string-equal lang "fr")
    (progn
      (setq ispell-dictionary "francais")))
  (if (string-equal lang "gb")
    (progn
...
(add-hook 'html-helper-mode-hook
	  '(lambda()
	     (define-key html-helper-mode-map "\C-zl" 'jl-ispell-lang)
	     (define-key html-helper-mode-map "\C-zw" 'ispell-word)
	     (define-key html-helper-mode-map "\C-zb" 'ispell-buffer)
	     )
	  )
